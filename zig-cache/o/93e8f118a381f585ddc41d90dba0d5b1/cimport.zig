...
pub const OID_MAX = @compileError("unable to translate macro: undefined identifier `UINT_MAX`"); // /opt/homebrew/opt/libpq/include/postgres_ext.h:39:9
pub const atooid = @compileError("unable to translate macro: undefined identifier `strtoul`"); // /opt/homebrew/opt/libpq/include/postgres_ext.h:42:9
