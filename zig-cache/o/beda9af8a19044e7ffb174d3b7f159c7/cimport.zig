...
pub const OID_MAX = @compileError("unable to translate macro: undefined identifier `UINT_MAX`"); // /Library/PostgreSQL/15/include/postgres_ext.h:39:9
pub const atooid = @compileError("unable to translate macro: undefined identifier `strtoul`"); // /Library/PostgreSQL/15/include/postgres_ext.h:42:9
